...
public class ExamActivity extends Activity {
	...
	public void initAssignment(String e) {
		...
		Cursor c = db.rawQuery("select * from Exams where Name ='" + e + "'",
				null);
		// get those values
		c.moveToFirst();
		...
		Exam ex = new Exam(name, new GregorianCalendar(dueYear, dueMonth,
				dueDay));
		...
		dateInView.setText(Integer.toString(dueMonth + 1) + "/"
				+ Integer.toString(dueDay) + "/" + Integer.toString(dueYear));
